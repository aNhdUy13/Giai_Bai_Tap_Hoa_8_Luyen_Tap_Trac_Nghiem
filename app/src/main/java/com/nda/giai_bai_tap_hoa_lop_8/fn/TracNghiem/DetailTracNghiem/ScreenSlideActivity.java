package com.nda.giai_bai_tap_hoa_lop_8.fn.TracNghiem.DetailTracNghiem;
...
import com.nda.giai_bai_tap_hoa_lop_8.fn.TracNghiem.DoneExam.ExamFinished;
...
public class ScreenSlideActivity extends FragmentActivity {
    ...
    private long timeLeftInMilliSecond = 900000; // 90 min = 5400000; 15 min = 900000
    ...
    private void initiate()
    {
        ...
        if (bundle.containsKey("tracNghiem"))
        {
            dialogReady();
...
//        txt_showNumberOfCorrectAns = (TextView) dialog.findViewById(R.id.txt_showNumberOfCorrectAns);
    ...
    {
        topicNumber  = intent.getStringExtra("tracNghiemTopic");
        examTitle   = intent.getStringExtra("tracNghiemTitle");

        txt_title.setText(examTitle);
        readDetail_luyenThi(topicNumber);
    }
    private void readDetail_luyenThi(String topicNumber) {
        InputStream inputStream = getResources().openRawResource(R.raw.trac_nghiem_detail);
